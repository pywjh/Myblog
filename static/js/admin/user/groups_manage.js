$(function () {
  ...
  $groupDel.click(function () { // 2. 点击触发删除事件
    let _this = this;
    let sGroupId = $(this).parents('tr').attr('data-id');
    let sGroupName = $(this).parents('tr').attr('data-name');
    // 获取用户个数/获取点击标签的父节tr节点的第二个td节点的所有内容
